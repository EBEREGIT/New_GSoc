<?php
		...
		$get_id = $_GET['correct_dish'];
		
		$get_dish = "select * from dish where dish_id = '$get_id'";
		...
		$row_dish = mysqli_fetch_array($run_dish);
			...
			$rest = $row_dish['dish_restaurant'];
			$qty = $row_dish['dish_quantity'];
			$key = $row_dish['dish_keywords'];
...
<form action="index.php?inserting_dishes" method="post" enctype="multipart/form-data">
		<div class="row" style="padding: 100px; padding-top: 0px;"> 
			...
			<div class="form-group" style="border: 2px solid #993300; border-radius: 6px;"> 
				...
				<input type="text" name="dish_qty" class="form-control" size="50%" placeholder="Enter Dish Quantity" value = "<?php echo $qty; ?>"> 

			</div>

			<div class="form-group" style="border: 2px solid #993300; border-radius: 6px;"> 
				
				<input type="text" name="dish_rest" class="form-control" size="50%" placeholder="Enter Dish Restaurant" value = "<?php echo $rest; ?>"> 

			   	</div>

			<div class="form-group" style="border: 2px solid #993300; border-radius: 6px;"> 
				
				<input type="text" name="dish_keywords" class="form-control" size="50%" placeholder="Enter Dish Keywords" value = "<?php echo $key; ?>"> 

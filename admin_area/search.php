...
<div class="table-responsive">
	<table class="table">
		...
		$get_v = "select * from visitors where visitor_name like '%$search_query%'";
	...
	<tr>
		...
		<td><a href = "index.php?correct_dish=<?php echo $dish_id; ?>">Edit</a></td>
		<td><a href = "index.php?delete_dish=<?php echo $dish_id; ?>">Delete</a></td>
	</tr>
	<?php } ?>

...
<head>
	<meta charset="utf-8">
	<title>All Dishes-TheNigerianPot</title>
...
<div class="nav nav-pills row navbar-right" role="navigation">
	...
	<div class="collapse navbar-collapse" id="collapse">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="all_dishes.php">All Dishes</a></li>
...
<div class="row">
	<div class="col-sm-12 col-lg-12">
		...
		echo "
		<h3> $name, Do You Know That You Can Add To Our List Of Dishes?</h3>
...
<div class="row">
	<div class="col-sm-4 col-lg-4">
		...
		$get_dish = "select * from dish order by RAND()";
		...
		if (!isset($_SESSION['email'])){
			...
			echo "<div class='row'><div><p><b><a href = 'sign.php?dish_id=$dish_id'>Make_Order</a></b></p></div></div>";
				
		}
		
		else{
		
			echo "<div class='row'><div><p><b><a href = 'order.php?dish_id=$dish_id'>Make_Order</a></b></p></div></div>";
...
<div class="row">
	<div class="col-sm-12 col-lg-12">
		...
		<h4><a href="visitors/add_dish.php">YOU CAN ADD MORE DISHES HERE</a></h4>
	</div>
</div>
...
<div class="row">
	<h3 style="width: 98.5%; text-align: center; margin: 10px;">Did You Find Our Site Helpful?</h3>
